...
<<<<<<< Updated upstream:src/python/mtio/modules/mtblender/src/blender_plugin.py
...
=======
    ...
    def getCustomAttribute(self, name: str) -> Any:
        ...
        try:
            ...
            return None
>>>>>>> Stashed changes:src/python/mtio/modules/mtblender/umvc3_model_importer/modules/blender_plugin.py
